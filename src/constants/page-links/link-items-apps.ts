...
const linkItems = [
  {
    description: 'A quick reference of standard emojis to search and copy.',
  ...
  {
    description:
      'Handy set of useful HTML code snippets with a copy to clipboard feature for ease-of-use.',
    icon: MdOutlineEmojiSymbols,
