...
const PUBLIC_ROUTE_PAGE_APPS_USEFUL_HTML_ENTITIES =
  '/apps/useful-html-entities';
const PUBLIC_ROUTE_PAGE_APPS_WEATHER = '/apps/weather';
//  games
...
const PUBLIC_ROUTE_PAGE_BLOG = '/blog';
...
const PUBLIC_ROUTE_PAGE_RESOURCES = '/resources';
const PUBLIC_ROUTE_PAGE_SITEMAP = '/sitemap';
...
const PUBLIC_ROUTE_PAGE_TUTORIALS_APP_TODO = `${PUBLIC_ROUTE_PAGE_TUTORIALS}/todo-app-with-recoil`;
const PUBLIC_ROUTE_PAGE_TUTORIALS_GAME_ROCK_PAPER_SCISSORS = `${PUBLIC_ROUTE_PAGE_TUTORIALS}/rock-paper-scissors-game-with-react`;
const PUBLIC_ROUTE_PAGE_TUTORIALS_MISC_TIKTOKBIOPAGE = `${PUBLIC_ROUTE_PAGE_TUTORIALS}/build-a-tik-tok-bio-page`;
